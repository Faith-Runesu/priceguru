        ...
        <div className="container mx-auto px-4" id='#products'>
            <div className="grid gap-6 mt-12 md:grid-cols-2 lg:grid-cols-3">
                {products.data && products.data.map((product, index) => (
                    <div key={index}
                        className="border border-gray-200 p-4 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out">
                        ...
                        <div className="flex-1 flex flex-col mt-4">
                            ...
                            <div classname="flex items-center">
                                <Link href={product.link} target='_blank'
                                    className='inline-flex items-center text-blue-500 hover:text-blue-600 transition-colors duration-200 ease-in-out'>
                                    <span>Goto site</span>
                                    <FaExternalLinkAlt className="ml-1" />
                                </Link>
                                <button type="button" onClick={() => onButtonClick(product)}
                                    className="ml-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                    Track
                                </button>
                            </div>
                        </div>
